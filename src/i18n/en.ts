...
export const en: Translations = {
  ...
  sunshine: "Sunshine",
  sunTrajectory: "Sun trajectory",
  sunTrajectoryDescription: "The curve represents the sun's elevation in the sky throughout the day",
  ...
  uvIndex: "UV Index",
  uvIndexDescription: "The UV index measures the intensity of ultraviolet solar radiation",
  uvNone: "None",
  uvLow: "Low",
  uvModerate: "Moderate",
  uvHigh: "High",
